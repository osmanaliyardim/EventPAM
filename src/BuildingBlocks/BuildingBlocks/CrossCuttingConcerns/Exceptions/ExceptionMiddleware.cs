using EventPAM.BuildingBlocks.CrossCuttingConcerns.Exceptions.Handlers;
...
namespace EventPAM.BuildingBlocks.CrossCuttingConcerns.Exceptions;
...
public class ExceptionMiddleware
{
    ...
    public ExceptionMiddleware
        (RequestDelegate next, IHttpContextAccessor contextAccessor, LoggerServiceBase loggerService)
    {
        _next = next;
