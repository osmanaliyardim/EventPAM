...
public static class JsonObjectContractProvider
{
    ...
    public static JsonObjectContract UsingNonDefaultConstructor(
        ...
        Type objectType,
        Func<ConstructorInfo, JsonPropertyCollection, IList<Newtonsoft.Json.Serialization.JsonProperty>> createConstructorParameters) =>
    ...
    private static ConstructorInfo? GetAttributeConstructor(Type objectType)
    {
        ...
        {
            1 => constructors[0],
            > 1 => throw new Newtonsoft.Json.JsonException($"Multiple constructors with a {ConstructorAttributeType.Name}."),
            _ => null
        };
    }
